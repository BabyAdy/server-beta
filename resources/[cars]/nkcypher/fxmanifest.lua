...
name 'nkcypher'
author 'Custom RPG'
description 'Masina addon: nkcypher'
version '0.1.0'
...
--  un fxmanifest.lua dintr-un subfolder de date al altei resurse NU se
--  încarcă niciodată -- FiveM citește manifeste doar din folderele listate
--  direct sub resources/ (sau direct sub un folder [categorie], ca [cars] aici).
-- ===========================================================================
