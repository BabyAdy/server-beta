...
Config.StaffClothingModels = {
    -- OWNER
    mask_staff_owner     = { male = { drawable = 0, texture = 0 }, female = { drawable = 14, texture = 0 } },
    ...
    -- MANAGER
    mask_staff_manager   = { male = { drawable = 0, texture = 0 }, female = { drawable = 14, texture = 1 } },
    ...
    -- Lead Admin
    mask_staff_admin     = { male = { drawable = 3, texture = 2 }, female = { drawable = 14, texture = 2 } },
    ...
    -- Helper
    mask_staff_helper    = { male = { drawable = 3, texture = 2 }, female = { drawable = 14, texture = 3 } },
    ...
    -- Anti-Cheat
    mask_staff_ac        = { male = { drawable = 3, texture = 2 }, female = { drawable = 14, texture = 4 } },
